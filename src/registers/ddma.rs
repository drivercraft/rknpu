...
pub struct DdmaRegisters {
    base: NonNull<DdmaRegs>,
}

impl DdmaRegisters {
    pub const unsafe fn from_base(base: NonNull<DdmaRegs>) -> Self {
        Self { base }
    }

    #[inline]
    pub fn regs(&self) -> &DdmaRegs {
        unsafe { self.base.as_ref() }
    }

    #[inline]
    pub fn regs_mut(&mut self) -> &mut DdmaRegs {
